document.addEventListener('DOMContentLoaded', function() {
    ...
    ConfettiCanvas.prototype.start = function() {
      // Logic to start the confetti animation
      console.log("Confetti started");
      // You should implement the actual logic for the confetti animation here
    };


    ConfettiCanvas.prototype.stop = function() {
      // Logic to stop the confetti animation
